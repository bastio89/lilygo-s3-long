 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font .pio/libdeps/t-display-s3-long/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 16 --bpp 4 --format lvgl --no-compress --range 0x00C4,0x00D6,0x00DC,0x00DF,0x00E4,0x00F6,0x00FC --lv-include lvgl.h --lv-font-name ui_font_montserrat_16_de --lv-fallback lv_font_montserrat_16 --output src/ui/font_montserrat_16_de.c
 ******************************************************************************/
...
#ifndef UI_FONT_MONTSERRAT_16_DE
#define UI_FONT_MONTSERRAT_16_DE 1
#endif

#if UI_FONT_MONTSERRAT_16_DE
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_montserrat_16_de = {
#else
lv_font_t ui_font_montserrat_16_de = {
#endif
...
#endif /*#if UI_FONT_MONTSERRAT_16_DE*/
